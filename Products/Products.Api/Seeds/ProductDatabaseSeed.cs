...
public class ProductDatabaseSeed : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var seedProducts = new List<Product>
        {
            ...
            new Snack(ObjectId.GenerateNewId(), "X-Bacon", 15, true, DateTime.Now, DateTime.Now, new List<string>(){"Pão", "Queijo", "Hamburgues", "Bacon"}),
            new Snack(ObjectId.GenerateNewId(), "Misto Quente", 7, true, DateTime.Now, DateTime.Now, new List<string>(){"Pão", "Queijo", "Presunto"}),
            new Snack(ObjectId.GenerateNewId(), "Bauru", 8, false, DateTime.Now, DateTime.Now, new List<string>(){"Pão", "Queijo", "Presunto", "Tomate"}),
            new Drink(ObjectId.GenerateNewId(), "Suco de Uva", 12, true, "M", DateTime.Now, DateTime.Now, "Uva"),
            new Drink(ObjectId.GenerateNewId(), "Suco de Maracuja", 12, false, "M", DateTime.Now, DateTime.Now, "Maracuja"),
